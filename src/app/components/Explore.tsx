...
export function Explore() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 pb-20">
      {/* Header */}
      <div className="sticky top-0 z-20 bg-gradient-to-r from-purple-600 to-blue-600 text-white">
      ...
      <div className="max-w-6xl mx-auto px-4 py-6 space-y-8">
        ...
        <motion.div
          ...
          className="bg-gradient-to-br from-purple-500 via-pink-500 to-orange-500 rounded-3xl p-6 text-white shadow-xl overflow-hidden relative"
        >
          {/* Background pattern */}
          ...
          <div className="relative">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h2 className="text-xl font-bold">Sports Roulette</h2>
            </div>
            ...
            <AnimatePresence mode="wait">
              {!isSpinning && !showSportDetail && (
                ...
                >
                  ...
                  <p className="text-lg font-medium mb-6">Ready to discover something new?</p>
                </motion.div>
              )}
              ...
              {isSpinning && (
                ...
                >
                  <motion.div
                    ...
                    className="text-6xl mb-4"
                  >
                    <Shuffle className="w-16 h-16 mx-auto" />
                  </motion.div>
                  <p className="text-lg font-medium">Spinning the roulette...</p>
                </motion.div>
              )}
              ...
              {showSportDetail && selectedSport && (
                ...
                >
                  <div className="text-center mb-4">
                    ...
                    <h3 className="text-2xl font-bold mb-2">{selectedSport.name}</h3>
                  ...
                  <div className="space-y-4 text-left">
                    <div>
                      <h4 className="font-semibold mb-1 text-white/90">What is it?</h4>
                      <p className="text-white/80 text-sm">{selectedSport.description}</p>
                    </div>
                    ...
                    <div className="bg-white/10 rounded-xl p-4">
                      ...
                      <p className="text-white/90 text-sm">{selectedSport.funFact}</p>
                    </div>
            ...
            {!showSportDetail && !isSpinning && (
              <Button
                ...
                className="w-full bg-white text-purple-600 hover:bg-white/90 font-bold py-6 text-lg"
              >
      ...
      <div className="md:hidden fixed bottom-0 left-0 right-0 z-40 bg-white border-t border-slate-200 safe-area-bottom">
        <div className="relative flex items-center justify-around h-16 px-2">
          ...
          <button
            ...
            className="flex flex-col items-center justify-center gap-1 text-purple-600 flex-1"
          >
