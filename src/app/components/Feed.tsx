...
import { articles, sports, teams, liveMatches } from '@/app/data/mockData';
...
const allSports = [
  ...
  { id: 'cricket', name: 'Cricket', icon: '🏏', color: '#38B2AC' },
  { id: 'rugby', name: 'Rugby', icon: '🏉', color: '#805AD5' },
  { id: 'volleyball', name: 'Volleyball', icon: '🏐', color: '#ED8936' },
  { id: 'badminton', name: 'Badminton', icon: '🏸', color: '#48BB78' },
  { id: 'table-tennis', name: 'Table Tennis', icon: '🏓', color: '#4299E1' },
  { id: 'swimming', name: 'Swimming', icon: '🏊', color: '#38B2AC' },
  { id: 'cycling', name: 'Cycling', icon: '🚴', color: '#9F7AEA' },
  { id: 'skiing', name: 'Skiing', icon: '⛷️', color: '#4299E1' },
  { id: 'skateboarding', name: 'Skateboarding', icon: '🛹', color: '#ED8936' },
  { id: 'surfing', name: 'Surfing', icon: '🏄', color: '#38B2AC' },
  { id: 'wrestling', name: 'Wrestling', icon: '🤼', color: '#F56565' },
  { id: 'archery', name: 'Archery', icon: '🏹', color: '#9F7AEA' },
  { id: 'fencing', name: 'Fencing', icon: '🤺', color: '#805AD5' },
  { id: 'esports', name: 'Esports', icon: '🎮', color: '#9F7AEA' },
  { id: 'motorsports', name: 'Motorsports', icon: '🏎️', color: '#F56565' },
];
...
export function Feed() {
  ...
  const filteredArticles = useMemo(() => {
    ...
    return filtered;
  }, [selectedFilter, searchQuery, preferences]);
        ...
        <div className="max-w-6xl mx-auto px-4 py-4">
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-3">
              ...
              />
              <div>
                <h1 className="text-xl font-bold text-slate-900">SportsFeed</h1>
                <p className="text-xs text-slate-500">Real-time sports news</p>
              </div>
            </div>
            ...
            <div className="flex-1 overflow-y-auto px-6 py-6 space-y-8">
              ...
              <div>
                <div className="flex items-center justify-between mb-3">
                  <div>
                    <h3 className="text-lg font-semibold text-slate-900">Sports</h3>
                    <p className="text-sm text-slate-500 mt-0.5">
                      {tempFilters.sports.length > 0 
                        ? `${tempFilters.sports.length} selected`
                        : 'Browse or search to find sports'}
                    </p>
                  </div>
                  {tempFilters.sports.length > 0 && (
                    <button
                        ...
                        >
                          <div className="flex items-start gap-3">
                            ...
                            <div className="flex-1 text-left">
                              <div className="text-sm font-semibold text-slate-900">{sport.name}</div>
                              {isSelected && (
                                <div className="text-xs text-[#1DB954] mt-0.5">Selected</div>
                              )}
                            </div>
                            {isSelected && (
