          ...
          >
            <div className="grid grid-cols-2 md:grid-cols-3 gap-3 mb-8">
              {sports.map((sport) => (
                ...
                >
                  {selectedSports.includes(sport.id) && (
                    <div className="absolute top-3 right-3 w-6 h-6 bg-[#1DB954] rounded-full flex items-center justify-center">
                  ...
                  {availableTeams.map((team) => (
                    ...
                    >
                      ...
                      <div className="text-left">
                        ...
                        <div className="text-sm text-slate-400 capitalize">{team.sport}</div>
                      </div>
                    </motion.button>
                  ))}
                </div>
                ...
                {sports.map((sport) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="text-4xl mb-3 opacity-80">{sport.icon}</div>
                      <div className="font-medium">{sport.name}</div>
                      {isHidden && (
                        <div className="text-xs text-red-400 mt-1">Hidden</div>
                      )}
                    </motion.button>
                  );
                })}
                ...
                {teams.map((team) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="text-3xl opacity-80">{team.logo}</div>
                      <div className="text-left flex-1">
                        <div className="font-medium">{team.name}</div>
                        <div className="text-sm text-slate-400 capitalize">
                          {team.sport}
                          {isHidden && <span className="ml-2 text-red-400">• Hidden</span>}
                        </div>
                      </div>
                    </motion.button>
                  );
