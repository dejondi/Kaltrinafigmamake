...
export const sports: Sport[] = [
  ...
  { id: 'football', name: 'Football', icon: '🏈', color: '#4A5568' },
  { id: 'soccer', name: 'Soccer', icon: '⚽', color: '#48BB78' },
  { id: 'baseball', name: 'Baseball', icon: '⚾', color: '#ED8936' },
  { id: 'hockey', name: 'Hockey', icon: '🏒', color: '#4299E1' },
  { id: 'tennis', name: 'Tennis', icon: '🎾', color: '#9F7AEA' },
  { id: 'golf', name: 'Golf', icon: '⛳', color: '#38B2AC' },
  { id: 'mma', name: 'MMA/Boxing', icon: '🥊', color: '#F56565' },
];

export const teams: Team[] = [
  { id: 'lakers', name: 'Lakers', sport: 'basketball', logo: '🟣' },
  { id: 'warriors', name: 'Warriors', sport: 'basketball', logo: '🔵' },
  { id: 'chiefs', name: 'Chiefs', sport: 'football', logo: '🔴' },
  { id: '49ers', name: '49ers', sport: 'football', logo: '🟡' },
  { id: 'real-madrid', name: 'Real Madrid', sport: 'soccer', logo: '⚪' },
  { id: 'barcelona', name: 'Barcelona', sport: 'soccer', logo: '🔵' },
];
